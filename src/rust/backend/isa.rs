        ...
        match instr {
            ...
            IRInstruction::Call { func, args } => {
                ...
                let fn_ptr = match func.as_str() {
                    ...
                    // OpenGL Cube (shader + geometry)
                    "jdb_gl_load_shader" => crate::backend::gpu::gl_cube::jdb_gl_load_shader as *const () as u64,
                    "jdb_gl_create_cube" => crate::backend::gpu::gl_cube::jdb_gl_create_cube as *const () as u64,
                    "jdb_gl_use_shader" => crate::backend::gpu::gl_cube::jdb_gl_use_shader as *const () as u64,
                    "jdb_gl_set_uniform_mvp" => crate::backend::gpu::gl_cube::jdb_gl_set_uniform_mvp as *const () as u64,
                    "jdb_gl_draw_cube" => crate::backend::gpu::gl_cube::jdb_gl_draw_cube as *const () as u64,
                    "jdb_gl_destroy_shader" => crate::backend::gpu::gl_cube::jdb_gl_destroy_shader as *const () as u64,
                    "jdb_gl_destroy_cube" => crate::backend::gpu::gl_cube::jdb_gl_destroy_cube as *const () as u64,
                    "jdb_gl_clear_depth" => crate::backend::gpu::gl_cube::jdb_gl_clear_depth as *const () as u64,
                    // Vulkan
                    ...
                    // Vulkan Cube
                    "jdb_vk_create_pipeline" => crate::backend::gpu::vk_cube::jdb_vk_create_pipeline as *const () as u64,
                    "jdb_vk_create_cube_mesh" => crate::backend::gpu::vk_cube::jdb_vk_create_cube_mesh as *const () as u64,
                    "jdb_vk_begin_frame" => crate::backend::gpu::vk_cube::jdb_vk_begin_frame as *const () as u64,
                    "jdb_vk_set_transform" => crate::backend::gpu::vk_cube::jdb_vk_set_transform as *const () as u64,
                    "jdb_vk_draw_mesh" => crate::backend::gpu::vk_cube::jdb_vk_draw_mesh as *const () as u64,
                    "jdb_vk_end_frame" => crate::backend::gpu::vk_cube::jdb_vk_end_frame as *const () as u64,
                    "jdb_vk_destroy_mesh" => crate::backend::gpu::vk_cube::jdb_vk_destroy_mesh as *const () as u64,
                    "jdb_vk_destroy_pipeline" => crate::backend::gpu::vk_cube::jdb_vk_destroy_pipeline as *const () as u64,
                    // DirectX12
                    ...
                    // DX12 Cube
                    "jdb_dx12_create_pso" => crate::backend::gpu::dx12_cube::jdb_dx12_create_pso as *const () as u64,
                    "jdb_dx12_create_cube_mesh" => crate::backend::gpu::dx12_cube::jdb_dx12_create_cube_mesh as *const () as u64,
                    "jdb_dx12_begin_frame" => crate::backend::gpu::dx12_cube::jdb_dx12_begin_frame as *const () as u64,
                    "jdb_dx12_set_transform" => crate::backend::gpu::dx12_cube::jdb_dx12_set_transform as *const () as u64,
                    "jdb_dx12_draw_mesh" => crate::backend::gpu::dx12_cube::jdb_dx12_draw_mesh as *const () as u64,
