                ...
                if let Some(t) = target {
                    ...
                    if let Some(cls) = class_name {
                        let native_fn = match (cls, name.as_str()) {
                            ...
                            ("OpenGL", "clearDepth")   => Some("jdb_gl_clear_depth"),
                            ("OpenGL", "destroy")      => Some("jdb_gl_destroy"),
                            ("OpenGL", "isAvailable")  => Some("jdb_gl_is_available"),
                            ("OpenGL", "loadShader")   => Some("jdb_gl_load_shader"),
                            ("OpenGL", "createCube")   => Some("jdb_gl_create_cube"),
                            ("OpenGL", "useShader")    => Some("jdb_gl_use_shader"),
                            ("OpenGL", "setUniformMVP") => Some("jdb_gl_set_uniform_mvp"),
                            ("OpenGL", "drawCube")     => Some("jdb_gl_draw_cube"),
                            ("OpenGL", "destroyShader") => Some("jdb_gl_destroy_shader"),
                            ("OpenGL", "destroyCube")  => Some("jdb_gl_destroy_cube"),
                            // Vulkan
                            ...
                            ("Vulkan", "createPipeline") => Some("jdb_vk_create_pipeline"),
                            ("Vulkan", "createCubeMesh") => Some("jdb_vk_create_cube_mesh"),
                            ("Vulkan", "beginFrame")   => Some("jdb_vk_begin_frame"),
                            ("Vulkan", "setTransform")  => Some("jdb_vk_set_transform"),
                            ("Vulkan", "drawMesh")     => Some("jdb_vk_draw_mesh"),
                            ("Vulkan", "endFrame")     => Some("jdb_vk_end_frame"),
                            ("Vulkan", "destroyMesh")  => Some("jdb_vk_destroy_mesh"),
                            ("Vulkan", "destroyPipeline") => Some("jdb_vk_destroy_pipeline"),
                            // DirectX12
                            ...
                            ("DirectX12", "createPSO")     => Some("jdb_dx12_create_pso"),
                            ("DirectX12", "createCubeMesh") => Some("jdb_dx12_create_cube_mesh"),
                            ("DirectX12", "beginFrame")    => Some("jdb_dx12_begin_frame"),
                            ("DirectX12", "setTransform")  => Some("jdb_dx12_set_transform"),
                            ("DirectX12", "drawMesh")      => Some("jdb_dx12_draw_mesh"),
