...
// Stubbed out until a replacement registry is implemented.

/// Minimal stub replacing the removed HeaderMain
struct HeaderMainStub;

impl HeaderMainStub {
    fn new() -> Self { Self }
    fn is_known_symbol(&self, _name: &str) -> bool { false }
    fn mark_used(&mut self, _name: &str) {}
    fn resolve_include(&self, _header: &str) -> Option<&str> { None }
}
...
pub struct HeaderResolver {
    ...
    /// TODO: was HeaderMain — stubbed until replacement is implemented
    header_main: HeaderMainStub,
}
...
impl HeaderResolver {
    pub fn new() -> Self {
        Self {
            ...
            header_main: HeaderMainStub::new(),
        }
    }
